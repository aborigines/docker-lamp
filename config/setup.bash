...
### run install
## copy source.list
cp $CONFIGDIR/sources.list /etc/apt/sources.list
apt-get update
...
a2enmod rewrite
cp $CONFIGDIR/000-default.conf /etc/apache2/sites-available/000-default.conf
...
#### mysql-server
cp $CONFIGDIR/my.cnf /etc/mysql/my.cnf
